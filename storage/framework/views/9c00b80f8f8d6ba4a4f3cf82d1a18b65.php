...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'categories-add']); ?>
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="<?php echo e(route('admin.category.store')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="bot">
                        <div></div>
                        <button class="tf-button w208" type="submit" loading='lezy'>Save</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH C:\Users\hp\Desktop\ECOMSELLER\resources\views/admin/category-add.blade.php ENDPATH**/ ?>