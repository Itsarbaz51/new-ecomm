...
<?php $component->withAttributes(['title' => 'E.COM.SELLER','bodyClass' => 'gradient-bg']); ?>
    <section class="swiper-container js-swiper-slider w-full h-[70vh] md:h-[80vh] lg:h-[90vh] relative" data-settings='{
        ...
        <div class="swiper-wrapper w-full h-full">
            ...
            <div class="swiper-slide w-full h-full relative">
                <img src="<?php echo e(asset('storage/uploads/slides/' . $slide->image)); ?>" alt="<?php echo e($slide->title); ?>" class="w-full h-full object-cover" loading="lazy" />
    ...
    <section class="products-tabs container">
        ...
        <div class="tabs overflow-auto">
            ...
            <a href="<?php echo e(route('home.index', ['categories' => $category->id])); ?>" class="tab <?php echo e($activeCategory == $category->id ? 'active' : ''); ?>">
        ...
        <div class="tab-content tab-active" id="productGrid">
            ...
            <div class="flex flex-col items-center justify-center py-16 text-center text-gray-500">
                <svg style="width: 50px" class="mb-4 text-red-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        ...
                        <div class="card h-100 w-72 lg:w-fit shadow-sm product-card product-hover">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide flex justify-center items-center">
                                            <a href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>">
                                                <img src="<?php echo e(asset('storage/uploads/products/thumbnails/' . $product->image)); ?>" class="object-contain" alt="<?php echo e($product->name); ?>">
                                            </a>
                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <a href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>">
                                                <img src="<?php echo e(asset('storage/uploads/products/gallery/' . trim($image))); ?>" class="card-img-top object-contain product-image" alt="<?php echo e($product->name); ?>">
                                            </a>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                            ...
                            <div class="card-body text-center">
                                ...
                                <h6 class="card-title mb-2">
                                    <a href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>" class="text-dark text-decoration-none"><?php echo e($product->name); ?></a>
                                </h6>
                                ...
                                <div class="d-flex justify-content-center align-items-center mb-3">
                                    <div class="product-single__rating">
                                        <div class="reviews-group d-flex">
                                            ...
                                            <?php for($i = 1; $i <= $roundedRating; $i++): ?> <svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg" fill="#FFD700">
                                                <use href="#icon_star" />
                                                </svg>
                                                <?php endfor; ?>

                                                
                                                <?php for($i = $roundedRating + 1; $i <= 5; $i++): ?> <svg class="star-rating__star-icon" width="12" height="12" fill="#ccc" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="container mw-1620 bg-white border-radius-10">
        ...
        <div class="py-4 px-4 md:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 xxl:grid-cols-4 gap-6">
                ...
                <div class="bg-white relative rounded-2xl shadow flex flex-col justify-center hover:shadow-md transition-all overflow-hidden">
                    <img loading="lazy" src="<?php echo e(asset('storage/uploads/categories/' . $categorie->image)); ?>" alt="<?php echo e($categorie->name); ?>" class="object-contain w-full max-h-[500px] rounded-lg" />
    ...
    <section class="mission w-full bg-red-900">
        <div class="mission-content w-full bg-black text-white">
            ...
            <div class="w-full lg:w-1/2">
                <img src="https://cdn.shopify.com/s/files/1/0775/7126/0764/files/iStock-520289888-2-e1641284826152-1024x640.jpg?v=1719407083" alt="Mission Sign" class='w-full'>
            </div>
        </div>
    </section>
                    ...
                    <div class="testimonial-reviews flex items-center justify-center">
                        <?php for($i = 1; $i <= $review->rating; $i++): ?>
                            <svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.962h4.163c.969 0 1.371 1.24.588 1.81l-3.37 2.448 1.287 3.962c.3.921-.755 1.688-1.538 1.118L10 13.347l-3.37 2.448c-.783.57-1.838-.197-1.538-1.118l1.287-3.962-3.37-2.448c-.783-.57-.38-1.81.588-1.81h4.163l1.286-3.962z" />
                            </svg>
                            <?php endfor; ?>
                            <?php for($i = $review->rating + 1; $i <= 5; $i++): ?> <svg class="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.962h4.163c.969 0 1.371 1.24.588 1.81l-3.37 2.448 1.287 3.962c.3.921-.755 1.688-1.538 1.118L10 13.347l-3.37 2.448c-.783.57-1.838-.197-1.538-1.118l1.287-3.962-3.37-2.448c-.783-.57-.38-1.81.588-1.81h4.163l1.286-3.962z" />
                                </svg>
                                <?php endfor; ?>
                    </div>
