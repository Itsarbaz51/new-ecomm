...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'slide-add']); ?>
...
unset($__errorArgs, $__bag); ?>
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Title" name="title" tabindex="0"
                            value="<?php echo e(old('title')); ?>" aria-required="true" required="">
                    </fieldset>
...
unset($__errorArgs, $__bag); ?>
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Link" name="link" tabindex="0"
                            value="<?php echo e(old('link')); ?>" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="category">
                        ...
                        <div class="select flex-grow">
                            <select class="" name="status">
                                ...
                                <option value="0" <?php if(old('status') == '0'): ?> selected <?php endif; ?>>Inactive
                                </option>
                            </select>
                        </div>
                    </fieldset>
...
<?php /**PATH C:\Users\hp\Desktop\ECOMSELLER\resources\views/admin/slide-add.blade.php ENDPATH**/ ?>