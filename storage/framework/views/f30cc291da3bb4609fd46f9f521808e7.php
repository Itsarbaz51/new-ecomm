...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'brand-edit']); ?>
                ...
                <form class="form-new-product form-style-1" action="<?php echo e(route('admin.brand.update')); ?>" method="post"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand name" name="name" tabindex="0"
                            value="<?php echo e($brand->name); ?>" aria-required="true" required="">
                    </fieldset>
...
unset($__errorArgs, $__bag); ?>
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand Slug" name="slug" tabindex="0"
                            value="<?php echo e($brand->slug); ?>" aria-required="true" required="">
                    </fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            ...
                            <?php if($brand->image): ?>
                                <div class="item" id="imgpreview">
                                    <img src="<?php echo e(asset('storage/uploads/brands/' . $brand->image)); ?>" class="effect8"
                                        alt="">
                                </div>
                            <?php endif; ?>
...
<?php /**PATH C:\Users\hp\Desktop\ECOMSELLER\resources\views/admin/brand-edit.blade.php ENDPATH**/ ?>