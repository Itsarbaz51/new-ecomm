    ...
    <section>
        <?php if($current_category): ?>
            <div class="hero-slide-wrapper">
                <img src="<?php echo e(asset('storage/uploads/categories/' . $current_category->image)); ?>"
                    alt=<?php echo e($current_category->name); ?> class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center text-white px-4">
                    <h1 class="text-3xl md:text-5xl font-bold mb-4 drop-shadow"><?php echo e(strtoupper($current_category->name)); ?> PRODUCTS</h1>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mb-2">
                                            <?php if($product->sale_price): ?>
                                                <span
                                                    class="text-decoration-line-through text-muted ms-1">₹<?php echo e($product->regular_price); ?></span>
