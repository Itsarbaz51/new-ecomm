...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Refund Policy']); ?>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="p-8">
                ...
                <div class="mb-6 space-y-4 text-gray-700 leading-relaxed">
                    ...
                    <p>For any return questions, contact us at <a href="<?php echo e(route('home.contact')); ?>"
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed mt-2">
                        ...
                        <a href="<?php echo e(route('home.contact')); ?>" class="text-blue-600 hover:underline">Contact</a>.
                    </p>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Desktop\ECOMSELLER\resources\views/home/refundPolicy.blade.php ENDPATH**/ ?>