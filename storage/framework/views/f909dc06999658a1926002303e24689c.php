...
<?php $component->withAttributes(['title' => 'OTP Verification']); ?>
    <div class="w-xl p-4 mx-auto">
        ...
        <form method="POST" action="<?php echo e(route('password.otp.verify.submit')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <a href="<?php echo e(route('otp.resend')); ?>">Did not get OTP? Resend</a>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Desktop\ECOMSELLER\resources\views/auth/passwords/otp.blade.php ENDPATH**/ ?>