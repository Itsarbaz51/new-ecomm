...
<footer>
    <div class="footer-links container ">
        <div class="footer-column">
            <h5>Links</h5>
            <a href="<?php echo e(route('home.privacyPolicy')); ?>">Privacy Policy</a>
            <a href="<?php echo e(route('home.refundPolicy')); ?>">Refund Policy</a>
            <a href="<?php echo e(route('home.shippingPolicy')); ?>">Shipping Policy</a>
            <a href="<?php echo e(route('home.termsOfService')); ?>">Terms of Service</a>
        </div>
        <div class="footer-column">
            <h5>Help</h5>
    ...
    <div class=" container flex sm:flex-row sm:justify-between justify-center items-center border-t border-gray-700 pt-4 flex-col">
        ...
        <ul class="flex justify-center items-center my-2">
            ...
            <li>
                <svg class="payment-icon" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24"
            ...
            <li>
                <svg class="payment-icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width="38"
                    height="24" role="img" aria-labelledby="pi-maestro">
