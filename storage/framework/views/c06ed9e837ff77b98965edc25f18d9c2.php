...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'coupon-add']); ?>
                ...
                <form class="form-new-product form-style-1" method="POST" action="<?php echo e(route('admin.coupon.store')); ?>">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Coupon Code" name="code" tabindex="0"
                            value="<?php echo e(old('code')); ?>" aria-required="true" required="">
                    </fieldset>
...
unset($__errorArgs, $__bag); ?>
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Coupon Value" name="value" tabindex="0"
                            value="<?php echo e(old('value')); ?>" aria-required="true" required="">
                    </fieldset>
                    <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Cart Value" name="cart_value"
                            tabindex="0" value="<?php echo e(old('cart_value')); ?>" aria-required="true" required="">
                    </fieldset>
...
unset($__errorArgs, $__bag); ?>
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="date" placeholder="Expiry Date" name="expiry_date"
                            tabindex="0" value="<?php echo e(old('expiry_date')); ?>" aria-required="true" required="">
                    </fieldset>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Desktop\ECOMSELLER\resources\views/admin/coupon-add.blade.php ENDPATH**/ ?>