<ul class="space-y-2 text-sm font-medium text-gray-700">
    ...
    <li class="li-user">
        <a href="<?php echo e(route('user.index')); ?>"
            class="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-gray-100 transition <?php echo e(request()->routeIs('user.index') ? 'bg-gray-200 font-semibold text-gray-900' : ''); ?>">
    ...
    <li>
        <a href="<?php echo e(route('user.orders')); ?>"
            class="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-gray-100 transition <?php echo e(request()->routeIs('user.orders') ? 'bg-gray-200 font-semibold text-gray-900' : ''); ?>">
            <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <li>
        <a href="<?php echo e(route('user.address')); ?>"
            class="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-gray-100 transition <?php echo e(request()->routeIs('user.address') ? 'bg-gray-200 font-semibold text-gray-900' : ''); ?>">
            <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <li>
        <a href="<?php echo e(route('user.account.details.edit', ['id' => Auth::user()->id])); ?>"
            class="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-gray-100 transition <?php echo e(request()->routeIs('user.account.details.edit') ? 'bg-gray-200 font-semibold text-gray-900' : ''); ?>">
            <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
